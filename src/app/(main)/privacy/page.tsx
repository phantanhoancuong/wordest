...
export default function PrivacyPage() {
  ...
  return (
    <div className={styles["privacy-page__content"]}>
      ...
      <p className={styles["policy-section__text"]}>Last updated: March 2026</p>
      <SettingsSection
        title="introduction"
      ...
      >
        <p className={styles["policy-section__text"]}>
          ...
          protected when you play Wordest. The goal of this policy is to clearly
          describe what data may be processed when you sign in using one of the
          third-party authentication providers providers including Facebook,
          Google, and Apple; play the game; or the interact with the
          application.
        </p>
        <p className={styles["policy-section__text"]}>
      ...
      >
        <p className={styles["policy-section__text"]}>
          ...
          authentication provider. This information may include your name, email
          address, a profile image, and a unique identifier associated with your
          account on that provider's platform.
        </p>
        <p className={styles["policy-section__text"]}>
          ...
          the basic profile information necessary to create and maintain a user
          account.
        </p>
      </SettingsSection>
      <SettingsSection
      ...
      >
        <p className={styles["policy-section__text"]}>
          ...
          use of the application is used solely for operating and improving the
          service. This includes creating and maintaining user aaccounts,
        ...
        <p className={styles["policy-section__text"]}>
          The information collected is NOT used for advertising purporses and is
      ...
      >
        <p className={styles["policy-section__text"]}>
          The service is hosted using infrastructure provided by Vercel. Account
          and application data are stored in a databased hosted by Turso. These
          infrastructure providers may process limited data as necessary to
          deliver hosting and database services required for the operation of
          the application.
        </p>
        <p className={styles["policy-section__text"]}>
      ...
      >
        ...
        <p className={styles["policy-section__text"]}>
          Account information and related gameplay data are retained only for as
          long as necessary to provide the service and maintain the user
        ...
        <p className={styles["policy-section__text"]}>
          ...
          contacting the email address listed at the end of this policy. Once a
          deletion request is verified and processed, the account and related
          stored information will permanently removed.
        </p>
      </SettingsSection>
      ...
      >
        <p className={styles["policy-section__text"]}>
          ...
          the application or legal requirements.
        </p>
