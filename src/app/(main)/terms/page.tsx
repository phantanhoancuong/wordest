...
export default function TermsPage() {
  ...
  return (
    <div className={styles["terms-page__scrollbar-wrapper"]}>
      <div className={styles["terms-page__content"]}>
        ...
        >
          <p className={styles["terms-section__text"]}>
            ...
            non-commercial use. Users agree to use the application only for
            lawful purposes and in a way that does not disrupt or harm the
            service.
          </p>
          <p className={styles["terms-section__text"]}>
        ...
        >
          <p className={styles["terms-section__text"]}>
            ...
            maintain an account using basic profile information provided by
            those services.
          </p>
          <p className={styles["terms-section__text"]}>
            Users are responsible for maintaining the integrity of their
            accounts and should not attempt to impersonate others or create
            accounts for abusive purposes.
          </p>
        </SettingsSection>
        ...
        >
          <p className={styles["terms-section__text"]}>
            ...
            interface elements, and branding, is the intellectual property of
            the creator unless otherwise stated.
          </p>
        </SettingsSection>
        ...
        >
          ...
          <p className={styles["terms-section__text"]}>
            ...
            damages, or interruptions resulting from the use of the service or
            the inability to access it.
          </p>
        </SettingsSection>
        ...
        >
          <p className={styles["terms-section__text"]}>
            ...
            changes in the application, its features, or legal requirements.
          </p>
          <p className={styles["terms-section__text"]}>
